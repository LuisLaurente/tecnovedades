...
<aside class="w-64 h-screen bg-gradient-to-b from-slate-50 to-blue-50 border-r border-blue-100 shadow-lg hidden lg:flex lg:flex-col">
    ...
    <nav class="mt-6 px-4 space-y-2 flex-1 overflow-y-auto pb-4">
        ...
        <!-- Pedidos -->
        <a href="<?= url('pedido/index'); ?>" class="group flex items-center px-4 py-3 text-gray-700 rounded-xl hover:bg-gradient-to-r hover:from-purple-100 hover:to-pink-100 hover:shadow-md transition-all duration-300 ease-in-out transform hover:scale-105">
